...
//                        die($get_user_func);
	 ...
	 * @return	array
	 */
	function create_user($username, $email, $password, $fullname, $company, $role, $phone, $email_activation, $company_name, $individual)
	{
		if ((strlen($username) > 0) AND !$this->ci->users->is_username_available($username)) {
			...
			$data = array(
				...
				'last_ip'	=> $this->ci->input->ip_address()
                        ...
                        if ($company = $this->is_company_available($company_name,$email)) {
                            $company_id = $company;
                        } else {
                            $company_id = $this -> _create_company($company_name,$email,$individual);
                        }
	...
	*/
	...
	function _create_company($company_name,$company_email,$individual){
