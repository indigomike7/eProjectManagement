...
<aside>
    <section class="foeditor-noborder">
        <textarea type="text" class="form-control  foeditor-500" name="notes" placeholder="<?=lang('type_your_note_here')?>"><?=$this-> applib ->get_project_details($project_id,'notes')?></textarea>
    </section>
