...
class Links extends MX_Controller {
		...
		if ($this->form_validation->run('projects','add_link') == FALSE)
		{
            ...
            if(config_item('slack_notification') == 'TRUE'){
                ...
                Applib::slack(
                          ...
                          sprintf(lang('slack_new_link_by'), Applib::login_info($this->user)->username)
                          );
            }
	...
	function edit()
	{
		...
		if ($this->form_validation->run('projects','add_link') == FALSE)
		{
			...
			$this -> db -> where('link_id',$link_id) -> update(Applib::$links_table,$this->input->post());
            ...
            if(config_item('slack_notification') == 'TRUE'){
                ...
                Applib::slack(
                          ...
                          sprintf(lang('slack_link_updated_by'), Applib::login_info($this->user)->username)
                          );
            }
