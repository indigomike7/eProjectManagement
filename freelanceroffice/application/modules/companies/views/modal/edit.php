                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in" id="tab-client-hosting">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" value="<?=$i->account_username?>" name="account_username" class="input-sm form-control" autocomplete="off">
                            </div>
                            <div class="form-group">
                                    <label><?=lang('account_password')?> </label>
                                    <input type="password" value="<?=$i->account_password?>"  name="account_password" class="input-sm form-control" autocomplete="off">
                            </div>
                            <div class="form-group">
