	...
	<section class="hbox stretch">
		...
		<p class="h4"><?=lang('all_payments')?></p>
			...
			foreach ($payment_details as $key => $i) { ?>
						<div class="btn-group">
						<a href="<?=base_url()?>invoices/payments/details/<?=$i->p_id?>" data-original-title="<?=lang('view_details')?>" data-toggle="tooltip" data-placement="top" class="btn btn-<?=config_item('theme_color');?> btn-sm"><i class="fa fa-info-circle"></i> <?=lang('payment_details')?></a>
						</div>
