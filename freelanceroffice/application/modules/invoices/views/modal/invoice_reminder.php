<div class="modal-dialog">
	...
	foreach ($invoice_details as $key => $invoice) { ?>
		...
		<div class="modal-body">
			...
			<input type="hidden" name="amount" value="<?=number_format($this -> applib -> calculate('invoice_due',$invoice->inv_id),config_item('currency_decimals'),config_item('decimal_separator'),config_item('thousand_separator'))?>">
