  ...
  <section class="panel panel-default">
              ...
              foreach ($payments as $key => $p) { ?>
                      ...
                      <?php
                        ...
                        <td style="border-left: 2px solid #1AB394;">
                          <div class="btn-group">
                        ...
                        <a class="text-info" href="<?=base_url()?>invoices/view/<?=$p->invoice?>"><?=$this -> applib->get_any_field('invoices',array('inv_id'=>$p->invoice),'reference_no')?></a></td>
                        <td>
                        ...
                        <strong>
                        <?=$this->applib->fo_format_currency($currency, $p->amount)?>
                        </strong>
                        </td>
