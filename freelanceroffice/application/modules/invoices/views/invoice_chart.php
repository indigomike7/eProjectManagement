<?php
  ...
  <div class="col-md-12">
        <div class="row">
                ...
                <?=$perc_paid?>,<?=$perc_outstanding?></div>
                     ...
                     <?=$this->applib->fo_format_currency(config_item('default_currency'), $outstanding)?></strong></small></div>
                  </section>
                </div>
                <div class="col-lg-4">
                  <section class="panel panel-default">
                  ...
                  <?=$this->applib->fo_format_currency(config_item('default_currency'), $total_receipts)?></strong></small></div>
                  </section>
                </div>
                <div class="col-lg-4">
                  <section class="panel panel-default">
                    ...
                    <div class="panel-footer"><small><?=lang('total_sales')?>: <strong>
                  <?=$this->applib->fo_format_currency(config_item('default_currency'), $total_sales)?></strong></small></div>
                  </section>
                </div>
              </div>
  ...
  <header class="panel-heading font-bold"><i class="fa fa-info-circle"></i> <?=lang('revenue_collection')?> - <?=config_item('default_currency')?></header>
