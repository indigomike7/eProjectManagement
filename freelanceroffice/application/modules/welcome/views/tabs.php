                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="projects">
                          ...
                          <table class="table table-striped m-b-none text-sm">
                            ...
                            <tbody>
<?php
$args = array('status !=' => 'Done');
$projects = $this->db->where($args)->order_by('date_created','desc')->get(Applib::$projects_table,5)->result();
if (!empty($projects)) {
    foreach ($projects as $key => $project) {
        $progress = round(Applib::getProgress($project->project_id),2);
        ?>
                                        <tr>
                                            ...
                                            <td><?=$this -> applib->get_any_field('companies',array('co_id'=>$project->client),'company_name')?>
                                            </td>


                                            <td><?php if ($progress >= 100) { $bg = 'success'; } else { $bg = 'danger'; } ?>
