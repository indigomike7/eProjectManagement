...
$state_to = $this -> applib -> company_details($inv->client,'state');
$country_to = $this -> applib -> company_details($inv->client,'country');
...
$to_vat = ($this -> applib -> company_details($inv->client,'VAT') != '') 
          ? $lang2['company_vat'].' | '.$this -> applib -> company_details($inv->client,'VAT') 
          : '';
