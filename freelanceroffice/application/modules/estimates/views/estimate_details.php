...
<section id="content">
    <section class="hbox stretch">
        ...
        <aside>
                    ...
                    <div class="row m-t-sm">
                        <div class="col-sm-8 m-b-xs">
                            ...
                            <?php if($role == '1' OR $this -> applib -> allowed_module('edit_estimates',$username)) { ?>
                                ...
                                <a data-original-title="<?=lang('convert_to_invoice')?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-sm btn-<?=config_item('theme_color')?> <?php if($estimate->invoiced == 'Yes' OR $estimate->client == '0'){ echo "disabled"; } ?>" href="<?=base_url()?>estimates/action/convert/<?=$estimate->est_id?>" data-toggle="ajaxModal"
            ...
            <?php } else{ ?>
            <?php if($estimate->status == 'Pending'){ $active_button = NULL; }else{ $active_button = 'disabled'; } ?>
                            <a class="btn btn-sm btn-success <?=$active_button?>" href="<?=base_url()?>estimates/action/status/accepted/<?=$estimate->est_id?>"><?=lang('mark_as_accepted')?></a>


                            <a class="btn btn-sm btn-danger <?=$active_button?>" href="<?=base_url()?>estimates/action/status/declined/<?=$estimate->est_id?>"><?=lang('mark_as_declined')?></a>
                ...
                <section class="scrollable wrapper ie-details">
                    ...
                    <section class="scrollable wrapper">
                        ...
                        <div class="col-xs-6">
                            ...
                            <?php $l = $this->applib->company_details($estimate->client, 'language'); ?>
                            ...
                            <p>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <span class="col-xs-9 no-gutter">
                                        ...
                                        <?php if ($this->applib->company_details($estimate->client, 'state') != '') { echo $this->applib->company_details($estimate->client, 'state').", ";  } ?>
                                    ...
                                    <?php if($this->applib->company_details($estimate->client, 'VAT') != ''){ ?>
                                    <span class="col-xs-3 no-gutter"><?= lang('company_vat') ?>:</span>
                                    <span class="col-xs-9 no-gutter"><?= $this->applib->company_details($estimate->client, 'VAT') ?>
                                    </span>
                                    <?php } ?>
                                    </p>
                                </div>
