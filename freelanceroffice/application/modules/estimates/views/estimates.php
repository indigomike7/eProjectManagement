...
<section class="scrollable wrapper w-f">
    <section class="panel panel-default">
                ...
                if($role == '1' OR $this -> applib -> allowed_module('add_estimates',$username) OR $this->tank_auth->user_role($this->tank_auth->get_role_id()) == 'e_finance') { ?> 
              ...
              <?php if($role == '1' OR $this -> applib -> allowed_module('edit_estimates',$username)OR $this->tank_auth->user_role($this->tank_auth->get_role_id()) == 'e_finance') { ?>  
                ...
                <?php } 
                if($role == '1' OR $this -> applib -> allowed_module('view_all_estimates',$username)OR $this->tank_auth->user_role($this->tank_auth->get_role_id()) == 'e_finance') { ?>  
            ...
            <li><a href="<?=base_url()?>estimates/view/<?=$e->est_id?>"><?=lang('view_estimate')?></a></li>
                        ...
                        <a class="text-info" href="<?=base_url()?>estimates/view/<?=$e->est_id?>"><?=$e->reference_no?>
                        </a>
                        ...
                        <td>
                        <?=$this -> applib->get_any_field('companies',array('co_id'=>$e->client),'company_name')?>
                        </td>
                        ...
                        <?=$this->applib->fo_format_currency($e->currency, $this -> applib -> est_calculate('estimate_amount',$e->est_id))?>
                        </td>
