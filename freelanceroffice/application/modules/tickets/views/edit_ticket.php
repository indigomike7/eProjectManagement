	...
	<section class="hbox stretch">
		...
		<p class="h4"><?=lang('all_tickets')?></p>
			...
			foreach ($ticket_details as $key => $i) { ?>
						<div class="btn-group">
						<a href="<?=base_url()?>tickets/view/<?=$i->id?>" data-original-title="<?=lang('view_details')?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-<?=config_item('theme_color');?> btn-sm"><i class="fa fa-info-circle"></i> <?=lang('ticket_details')?></a>
						</div>
          ...
          echo form_open_multipart(base_url().'tickets/edit/',$attributes);
           ?>
			...
			<div class="form-group">
				...
				<div class="col-lg-8">
				<textarea name="body" class="form-control foeditor"><?=$i->body?></textarea>
