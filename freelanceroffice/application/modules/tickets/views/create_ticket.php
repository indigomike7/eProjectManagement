			 ...
			 <input type="hidden" name="department" value="<?=$_GET['dept']?>">
				...
				<div class="col-lg-3">
					<input type="text" class="form-control" style="width:260px" value="<?php  
						...
						echo strtoupper(random_string('alnum', 7)); ?>" name="ticket_code" readonly="readonly">
				</div>
				</div>
...
<button type="submit" class="btn btn-sm btn-<?=config_item('theme_color')?>"><i class="fa fa-ticket"></i> <?=lang('create_ticket')?></button>
