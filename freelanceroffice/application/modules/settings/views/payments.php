            ...
            <section class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="text" class="form-control" data-toggle="tooltip" data-placement="top" data-original-title="<?=lang('change_if_necessary')?>" value="<?=config_item('paypal_ipn_url')?>" name="paypal_ipn_url">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?=lang('paypal_cancel_url')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control" data-toggle="tooltip" data-placement="top" data-original-title="<?=lang('change_if_necessary')?>"  value="<?=config_item('paypal_cancel_url')?>" name="paypal_cancel_url">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?=lang('paypal_success_url')?></label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control" data-toggle="tooltip" data-placement="top" data-original-title="<?=lang('change_if_necessary')?>"  value="<?=config_item('paypal_success_url')?>" name="paypal_success_url">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?=lang('notify_payment_received')?></label>
                        <div class="col-lg-3">
                            <label class="switch">
