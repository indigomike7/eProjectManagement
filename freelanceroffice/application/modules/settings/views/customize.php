    ...
    <div class="col-lg-12">
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <script src="https://cdn.jsdelivr.net/ace/1.1.8/min/ext-beautify.js" type="text/javascript" charset="utf-8"></script>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button id="saveeditor" class="btn btn-sm btn-<?=config_item('theme_color');?>"><?=lang('save_changes')?></button>
                </div>
            </div>
        </section>
    </div>
