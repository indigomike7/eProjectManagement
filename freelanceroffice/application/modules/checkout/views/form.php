...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <h4 class="modal-title"><?=lang('due_amount')?> <strong><?=$invoice_info['currency']?> <?=number_format($invoice_info['amount'],2)?></strong> for Invoice #<?=$invoice_info['item_name']?> via 2Checkout</h4>
        </div>
        ...
        <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input type="text" class="form-control input-medium" name="amount" autocomplete="off" value="<?=number_format($invoice_info['amount'],2)?>" required>
                </div>
        </div>
...
<script>
    ...
    $(function() {
        ...
        <?php $twocheckout_status = (config_item('two_checkout_live') == 'TRUE') ? 'production' : 'sandbox'; ?>
        TCO.loadPubKey('<?=$twocheckout_status?>');
