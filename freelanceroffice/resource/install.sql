...
# Database: folite
# Generation Time: 2016-01-14 10:23:22 +0000
# ************************************************************
...
VALUES
	...
	('company_email','company@domain.com'),
	('company_fax',''),
	...
	('paypal_email','billing@domain.com'),
	...
	('website_name','Gitbench LLC'),
	('xrates_check','2016-01-14');
...
VALUES
	('AED','United Arab Emirates Dirham','ARE',3.67292),
	('AUD','Australian Dollar','$',1.43631),
	('BRL','Brazilian Real','R$',4.02202),
	('CAD','Canadian Dollar','$',1.43314),
	('CHF','Swiss Franc','Fr',1.00551),
	('CLP','Chilean Peso','$',727.84920),
	('CNY','Chinese Yuan','¥',6.57681),
	('CZK','Czech Koruna','Kč',24.86275),
	('DKK','Danish Krone','kr',6.86570),
	('EUR','Euro','€',0.91988),
	('GBP','British Pound','£',0.69212),
	('HKD','Hong Kong Dollar','$',7.76154),
	('HUF','Hungarian Forint','Ft',290.92880),
	('IDR','Indonesian Rupiah','Rp',13858.81667),
	('ILS','Israeli New Shekel','₪',3.93610),
	('INR','Indian Rupee','INR',66.87811),
	('JPY','Japanese Yen','¥',117.80560),
	('KES','Kenya shillings','kes',102.39030),
	('KRW','Korean Won','₩',1208.64835),
	('MXN','Mexican Peso','$',17.90776),
	('MYR','Malaysian Ringgit','RM',4.39122),
	('NOK','Norwegian Krone','kr',8.83959),
	('NZD','New Zealand Dollar','$',1.53120),
	('PHP','Philippine Peso','₱',47.43805),
	('PKR','Pakistan Rupee','₨',104.98500),
	('PLN','Polish Zloty','zł',4.00400),
	('RUB','Russian Ruble','₽',75.98240),
	('SEK','Swedish Krona','kr',8.52842),
	('SGD','Singapore Dollar','$',1.43669),
	('THB','Thai Baht','฿',36.30004),
	('TRY','Turkish Lira','₺',3.02816),
	('TWD','Taiwan Dollar','$',33.43014),
	('USD','US Dollar','$',1.00000),
	('VEF','Bolívar Fuerte','Bs.',6.32052),
	('ZAR','South African Rand','R',16.58792);
