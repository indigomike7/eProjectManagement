			...
			"attachments": [
					        {
					            ...
					            "pretext": "'.sprintf(lang('slack_created_ticket'),
					            				Applib::displayName($user),$data->ticket_code).'",
			...
			"attachments": [
					        {
					            ...
					            "pretext": "'.sprintf(lang('new_project_pretext'),
					            			Applib::displayName($user),ucfirst($data->project_title)).'",
			...
			"attachments": [
					        {
					            ...
					            "pretext": "'.sprintf(lang('new_comment_pretext'),
					            			Applib::displayName($com->posted_by)).'",
					            ...
					            "fields": [
                							{
                    							"title": "Creator",
                    							"value": "'.Applib::displayName($com->posted_by).'",
                    							"short": true
                							},
							                {
							                    "title": "Project Title",
			...
			"attachments": [
					        {
					            ...
					            "pretext": "'.sprintf(lang('new_reply_pretext'),
					            			Applib::displayName($com->replied_by)).'",
					            ...
					            "fields": [
                							{
                    							"title": "Creator",
                    							"value": "'.Applib::displayName($com->replied_by).'",
                    							"short": true
                							},
							                {
							                    "title": "Project Title",
			...
			"attachments": [
					        {
					            ...
					            "pretext": "'.sprintf($pretext,
					            			Applib::displayName($user),ucfirst($m->milestone_name)).'",
			...
			"attachments": [
					        {
					            ...
					            "pretext": "'.sprintf(lang('upload_project_file'),
					            			Applib::displayName($params['user'])).'",
					            ...
					            "fields": [
                							{
                    							"title": "Uploaded by",
                    							"value": "'.Applib::displayName($params['user']).'",
                    							"short": true
                							},
							                {
							                    "title": "Project Title",
			...
			"attachments": [
					        {
					            ...
					            "fields": [
                							{
                    							"title": "Reporter",
                    							"value": "'.Applib::displayName($bug->reporter).'",
                    							"short": true
                							},
							                {
							                    "title": "Project Title",
