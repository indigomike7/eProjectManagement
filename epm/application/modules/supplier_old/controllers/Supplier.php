...
class Supplier extends MX_Controller {
	...
	function __construct()
	{
		...
		if ($this->tank_auth->user_role($this->tank_auth->get_role_id()) != 'admin' && $this->tank_auth->user_role($this->tank_auth->get_role_id()) != 'internalsales' && $this->tank_auth->user_role($this->tank_auth->get_role_id()) != 'procurement')
                {
