            ...
            <li class="<?php if($page == lang('calendar')){echo  "active"; }?>">
              ...
              <li class="<?php if($page == lang('clients')){echo  "active"; }?>">
                ...
                <li class="<?php if($page == lang('projects')){echo  "active"; }?>"> <a href="<?=base_url()?>projects" > <?php if($timer_on > 0){?><b class="badge bg-danger pull-right"><?=$timer_on?> <i class="fa fa-refresh fa-spin"></i></b><?php } ?>
                    <i class="fa fa-coffee icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
                ...
                <li class="<?php if($page == lang('messages')){echo  "active"; }?>"> <a href="<?=base_url()?>messages" >
                    <?php if($unread > 0){ ?><b class="badge bg-primary pull-right"><?=$unread?></b><?php } ?>  <i class="fa fa-envelope-o icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
                ...
                <li class="<?php if($page == lang('items')){echo  "active"; }?>"> <a href="<?=base_url()?>items"> <i class="fa fa-list icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
                <span><?=lang('items')?> </span> </a>
                </li>


                <li class="<?php if($page == lang('settings')){echo  "active"; }?>"> <a href="<?=base_url()?>settings" > <i class="fa fa-cogs icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
                ...
                <li class="<?php if($page == lang('role') OR $page == lang('users') ){echo  "active"; }?>">
                  ...
                  <ul class="nav lt">
                <li class="<?php if($page == lang('role')){echo  "active"; }?>"> <a href="<?=base_url()?>users/role" > <i class="fa fa-lock icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
                  <span><?=lang('role')?> </span> </a>
                </li>
