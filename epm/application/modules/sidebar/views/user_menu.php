          ...
          <nav class="nav-primary hidden-xs">
            <ul class="nav">
              <li class="<?php if($page == lang('home')){echo  "active"; }?>">
                <a href="<?=base_url()?>clients"> <i class="fa fa-dashboard icon">
              ...
              <li class="<?php if($page == lang('messages')){echo  "active"; }?>"> <a href="<?=base_url()?>messages" > <b class="badge bg-success pull-right"><?=Applib::count_num_rows(Applib::$messages_table,array('user_to'=>$this->tank_auth->get_user_id(),'status' => 'Unread'))?></b>
                <i class="fa fa-envelope-o icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
              ...
              <li class="<?php if($page == lang('invoices')){echo  "active"; }?>"> <a href="<?=base_url()?>invoices" > <i class="fa fa-list icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
                ...
                <li class="<?php if($page == lang('payments')){echo  "active"; }?>"> <a href="<?=base_url()?>clients/payments" > <i class="fa fa-money icon"> <b class="bg-<?=config_item('theme_color');?>"></b> </i>
