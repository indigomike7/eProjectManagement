...
<?php
           ...
           ?>
			 <?php echo validation_errors(); ?>
				...
				<div class="col-lg-5">
					<input type="text" class="form-control" value="<?=config_item('invoice_prefix')?><?php 
						...
						echo random_string('nozero', 6);
							...
							echo $this -> applib -> generate_invoice_number(); 
						} 
					?>" name="reference_no">
				</div>
				...
				<div class="input-group">
					...
					<input class="form-control " type="text" value="<?=config_item('default_tax')?>" name="tax">
				</div>
                                </div>
                                </div>
	...
	<?php } else{ ?><input type="hidden" name="allow_bitcoin" value="off"> <?php } ?>		        
				...
				<div class="col-lg-9">
				<textarea name="notes" class="form-control foeditor"><?=config_item('default_terms')?></textarea>
