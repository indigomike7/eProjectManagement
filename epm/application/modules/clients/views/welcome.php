...
<?=lang('your_balance_due')?> <?=$this->applib->fo_format_currency($cur->code, $client_outstanding)?></strong>
</div>
<?php } ?>
...
<small class="text-muted text-uc"><?=lang('invoices')?> </small> </a>
                ...
                <table class="table table-striped m-b-none text-sm">
						...
						?>
							...
							<td class="col-currency">
                                                            <?=$this->applib->fo_format_currency($cur->code, $project_cost)?>
                                                        </td>
	...
	<?=$this->user_profile->count_rows('projects',array(
			...
			<div class="panel-body text-center"> <h4><small> <?=lang('paid_amount')?> : </small>
				<?=$this->applib->fo_format_currency($cur->code, $this->user_profile->get_sum('payments','amount',array('paid_by'=>$user_company)))?></h4>
				<small class="text-muted block">
				<?=lang('outstanding')?> : <?=$this->applib->fo_format_currency($cur->code, $client_outstanding)?>
				</small>
				<div class="inline">
			...
			<div class="panel-footer"><small><?=lang('invoice_amount')?>: 
                        <strong><?=$this->applib->fo_format_currency($cur->code, $client_payable)?></strong></small>
			</div> </section>
		</div>
	</div>
	<div class="row">
