...
<p>Freelancer Office v.<?=config_item('version')?> <?=config_item('company_name')?> </p> </header> <section> <section class="hbox stretch"> 
<section> 
<section class="vbox"> 
...
<p>Powered by: Freelancer Office v.<?=config_item('version')?></p> </footer> 
