...
<header class="header bg-white b-b clearfix">
    ...
    <div class="table-responsive">
                  <table id="table-files" class="table table-striped b-t b-light small AppendDataTables">
                    <thead>
                      <tr>
                  ...
                  ?>
                      <tr class="file-item">
                        <td>
                            ...
                            <p class="file-text"><?=nl2br_except_pre($this->applib->short_string($f->description,100,0,100))?></p>
                        </td>
                        ...
                        <?php
                          ...
                          <?php }else{ ?>
                          <img src="<?=base_url()?>resource/avatar/<?=Applib::profile_info($f->uploaded_by)->avatar?>" class="img-circle" data-toggle="tooltip" data-title="<?=ucfirst(Applib::displayName($f->uploaded_by))?>" data-placement="top">
                        <?php } ?>
                          </a>
                        </td>
                        <td>
