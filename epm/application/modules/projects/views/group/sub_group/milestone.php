        ...
        <tbody>
          ...
          if (!empty($tasks)) {
            ...
            <tr>
              ...
              <td>
                <div class="inline ">
                  <div class="easypiechart text-<?=config_item('theme_color')?>" data-percent="<?=$t->task_progress?>" data-line-width="5" data-track-Color="#f0f0f0" data-bar-color="#<?php if($t->task_progress == 100){ echo '8ec165';}else{ echo 'fb6b5b'; } ?>" data-rotate="270" data-scale-Color="false" data-size="50" data-animate="2000">
