    ...
    <div class="table-responsive">
              ...
              foreach ($bugs as $key => $b) { 
                ...
                ?>
                      ...
                      <tr>                        
                        <td style="border-left: 2px solid <?php if($b->bug_status == 'Resolved') { echo '#16a085';}else{ echo '#e05d6f'; } ?>; ">

                        



               <a class="pull-left thumb-xs avatar" data-toggle="tooltip" data-original-title="<?=ucfirst(Applib::displayName($b->reporter))?>">
      ...
      <img src="<?=base_url()?>resource/avatar/<?=Applib::profile_info($b->reporter)->avatar?>" class="img-circle">
        <?php } ?> 
                        ...
                        <a class="text-info" href="<?=base_url()?>projects/view/<?=$b->project?>?group=bugs&view=bug&id=<?=$b->bug_id?>" data-original-title="<?=$b->bug_description?>" data-toggle="tooltip" data-placement="right" title = "" ><?=$issue_title?></a>
