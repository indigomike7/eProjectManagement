              ...
              <section class="media-body">
                <section class="panel panel-default">
                  ...
                  echo form_open(base_url().'projects/comment/',$attributes); ?>
                    ...
                    <textarea class="form-control foeditor-100" name="comment" placeholder="<?=$project_title?> <?=lang('comment')?>" required></textarea>
  ...
  <?php } ?>
              ...
              <section class="comment-body panel panel-default">
                ...
                <div class="panel-body">
                  <div class="text-muted small"><?=nl2br_except_pre($c->message)?></div>
                ...
                <?php
                  ...
                  if (!empty($comment_replies)) {
                      ...
                      <article id="comment-id-2" class="comment-item comment-reply">
                          <?php if ($this->applib->user_exists($reply->replied_by)) { ?>
                      <a class="pull-left thumb-sm avatar">
