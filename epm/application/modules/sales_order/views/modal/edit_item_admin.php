<div class="modal-dialog">
	<div class="modal-content">
						<?php
						echo form_open(base_url().'sales_order/view/details_item_admin/'.$soi_id.'/'.$so_id); ?>
		...
		<button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title">Update Sales Order Item</h4>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                    <?=$sales_order_items[0]->description?>
                    </div>
                </div>
<!--
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        ...
                        <option value="<?=$cur->code?>"<?=($sales_order_items[0]->currency == $cur->code ? ' selected="selected"' : '')?>><?=$cur->name?></option>
                        <?php endforeach; ?>
                        </select>
                    </div>
                </div>
-->
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                    <input type="text" name="unit_cost" class="form-control" value="<?=$sales_order_items[0]->unit_cost?>" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-9">Sub Cost<span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                    <input type="text" name="sub_cost" class="form-control" value="<?=$sales_order_items[0]->sub_cost?>" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-9">Cost<span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                    <input type="text" name="cost" class="form-control" value="<?=$sales_order_items[0]->cost?>" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-9">Total Cost<span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                    <input type="text" name="total_cost" class="form-control" value="<?=$sales_order_items[0]->total_cost?>" required/>
                    </div>
                </div>
