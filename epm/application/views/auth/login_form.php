...
<!--		<a class="navbar-brand block" href="<?=base_url()?>">
			...
			<img src="<?=base_url()?>resource/images/<?=config_item('company_logo')?>" class="img-responsive m-r-sm thumb-sm">
...
<?php echo form_close(); ?>
	...
	<div class="text-center text-white padder">
		<p style="font-size:19px;"> e Project Management Office  
		<br>&copy; <?=date('Y')?> <a href="<?=config_item('company_domain')?>" target="_blank"><?=config_item('company_name')?></a>  </p>
	</div> 
	</footer>
        <?php endif; ?>
	<!-- / footer -->
